...
func Test_aurora_methods(t *testing.T) {
	...
	test("Gray", a.Gray("x"), BlackFg|BrightFm)
	test("LightRed", a.LightRed("x"), RedFg|BrightFm)
	test("LightGreen", a.LightGreen("x"), GreenFg|BrightFm)
	test("Yellow", a.Yellow("x"), BrownFg|BrightFm)
	test("LightBlue", a.LightBlue("x"), BlueFg|BrightFm)
	test("LightMagenta", a.LightMagenta("x"), MagentaFg|BrightFm)
	test("LightCyan", a.LightCyan("x"), CyanFg|BrightFm)
	test("White", a.White("x"), GrayFg|BrightFm)
	...
	test("BgGray", a.BgGray("x"), BlackBg|BrightFm)
	test("BgLightRed", a.BgLightRed("x"), RedBg|BrightFm)
	test("BgLightGreen", a.BgLightGreen("x"), GreenBg|BrightFm)
	test("BgYellow", a.BgYellow("x"), BrownBg|BrightFm)
	test("BgLightBlue", a.BgLightBlue("x"), BlueBg|BrightFm)
	test("BgLightMagenta", a.BgLightMagenta("x"), MagentaBg|BrightFm)
	test("BgLightCyan", a.BgLightCyan("x"), CyanBg|BrightFm)
	test("BgWhite", a.BgWhite("x"), GrayBg|BrightFm)
	test("Bold", a.Bold("x"), BoldFm)
	test("Inverse", a.Inverse("x"), InverseFm)
	test("Bright", a.Bright("x"), BrightFm)
