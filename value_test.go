...
func TestValue_colors(t *testing.T) {
	...
	test("Gray", Red("x").Gray(), BlackFg|BrightFm)
	test("BrightRed", Bright("x").Red(), RedFg|BrightFm)
	test("LightRed", Bold("x").LightRed(), RedFg|BoldFm|BrightFm)
	test("LightGreen", Inverse("x").LightGreen(), GreenFg|InverseFm|BrightFm)
	test("Inverse&Yellow", Bold("x").Inverse().Yellow(), BoldFm|InverseFm|BrownFg|BrightFm)
	test("LightBlue", BgBlue("x").LightBlue(), BlueFg|BlueBg|BrightFm)
	test("LightMagenta", Magenta("x").LightMagenta(), MagentaFg|BrightFm)
	test("LightCyan", Red("x").LightCyan(), CyanFg|BrightFm)
	test("White", Green("x").White(), GrayFg|BrightFm)
	...
	test("BgGray", Black("x").BgGray(), BlackFg|BlackBg|BrightFm)
	test("BgLightRed", LightRed("x").BgLightRed(), RedFg|RedBg|BrightFm)
	test("BgLightGreen", LightGreen("x").BgLightGreen(), GreenFg|GreenBg|BrightFm)
	test("BgYellow", Yellow("x").BgYellow(), BrownFg|BrownBg|BrightFm)
	test("BgLightBlue", LightBlue("x").BgLightBlue(), BlueFg|BlueBg|BrightFm)
	test("BgLightMagenta", BgLightCyan("x").BgLightMagenta(), MagentaBg|BrightFm)
	test("BgLightCyan", LightCyan("x").BgLightCyan(), CyanFg|CyanBg|BrightFm)
	test("BgWhite", White("x").BgWhite(), GrayFg|GrayBg|BrightFm)
	test("Bold & BlueBg", Red("x").BgBlue().Bold(), RedFg|BoldFm|BlueBg)
	test("Inverse", Black("x").Inverse(), BlackFg|InverseFm)
	test("Bright", Black("x").Bright(), BlackFg|BrightFm)
	// clear
	...
	test("Bright", valueClear{"x"}.Bright(), 0)
}
